...
mapping gift_list = ([
        ...
        "12"  :   ([ "达成条件" : "制造如意乾坤袋",
                     ...
                     "奖励描述" : "/clone/fam/gift/int3:3,/clone/goods/duihuanjuan:1,exp:50000",
                     "下个奖励" : "14", ]),
        ...
        "19"  :   ([ "达成条件" : "使用 recall back 回到扬州",
                     ...
                     "奖励描述" : "neili:10000,jingli:5000,/adm/npc/obj/giftbox:1",
                     "下个奖励" : "20", ]),
        ...
        "180"  :  ([ "达成条件" : "装备绿化",
                     ...
                     "条件描述" : "将装备进行绿化，绿化后的装备组成套装，拥有极品属性\n"
                                  HIR "              提示：先给干将雪海之晶，然后dosuit <装备>，绿化装备详情参见 help suit" NOR,
